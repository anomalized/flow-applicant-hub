...
BEGIN
  ...
  VALUES (ws, 'Senior Frontend Engineer', 'Engineering', 'open', (now() + interval '30 days')::date, 'Build delightful product experiences with React and TypeScript.')
  RETURNING id INTO job1;

  INSERT INTO public.jobs (workspace_id, title, department, status, due_date, description)
  VALUES (ws, 'Product Designer', 'Design', 'open', (now() + interval '21 days')::date, 'Own end-to-end design for core product surfaces.')
  RETURNING id INTO job2;

  INSERT INTO public.jobs (workspace_id, title, department, status, due_date, description)
  VALUES (ws, 'Customer Success Manager', 'Customer Success', 'open', (now() + interval '45 days')::date, 'Drive adoption and renewal across our enterprise accounts.')
  RETURNING id INTO job3;

  INSERT INTO public.candidates (workspace_id, full_name, email, phone) VALUES (ws, 'Ava Thompson', 'ava.thompson@example.com', '+1 415 555 0142') RETURNING id INTO c1;
  INSERT INTO public.candidates (workspace_id, full_name, email, phone) VALUES (ws, 'Marcus Chen', 'marcus.chen@example.com', '+1 415 555 0188') RETURNING id INTO c2;
  INSERT INTO public.candidates (workspace_id, full_name, email, phone) VALUES (ws, 'Priya Natarajan', 'priya.n@example.com', '+1 415 555 0119') RETURNING id INTO c3;
  INSERT INTO public.candidates (workspace_id, full_name, email, phone) VALUES (ws, 'Liam O''Connor', 'liam.oconnor@example.com', '+353 1 555 0177') RETURNING id INTO c4;
  INSERT INTO public.candidates (workspace_id, full_name, email, phone) VALUES (ws, 'Sofia Alvarez', 'sofia.alvarez@example.com', '+34 91 555 0163') RETURNING id INTO c5;
  INSERT INTO public.candidates (workspace_id, full_name, email, phone) VALUES (ws, 'Noah Kim', 'noah.kim@example.com', '+82 2 555 0124') RETURNING id INTO c6;
